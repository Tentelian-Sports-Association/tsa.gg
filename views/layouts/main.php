...
<!-- Hier sp�ter weider die sachen f�r den Alert einf�gen -->
            ...
            <a href="#" class="footer-link d-flex align-items-center">
                <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0)">
                        ...
                        <path d="M9.28606 12.239C9.96743 12.239 10.5223 11.664 10.5223 10.9548C10.5223 10.2504 9.97127 9.67542 9.28989 9.67542L9.28606 9.67829C8.60468 9.67829 8.0498 10.2514 8.0498 10.9605C8.0498 11.664 8.60468 12.239 9.28606 12.239Z" fill="white" />
                    </g>
                    <defs>
                        <clipPath id="clip0">
