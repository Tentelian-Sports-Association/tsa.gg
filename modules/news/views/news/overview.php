            ...
            <ul class="categorie-list row list-unstyled">
                <?php foreach($categories as $categorie) : ?>
                    <li class="categorie-item col-12 col-lg-4">
                        <?= Html::a(Html::img(Yii::$app->HelperClass->checkImage('/images/news/categorie/', $categorie['img']) . '.webp', ['aria-label' => $categorie['name'], 'class' => 'img-fluid','onerror' => 'this.src=\'' . Yii::$app->HelperClass->checkImage('/images/news/categorie/', $categorie['img']) . '.png\''])		
                                        . '<h3 class="categorie-header">' . $categorie['name'] . '</h3>'
                        , ['categorie', 'categorieId' => $categorie['ID']], ['class' => 'categorie-link']); ?>
                    </li>
                <?php endforeach; ?>
            </ul>
            <div class="ad-block-container row">
