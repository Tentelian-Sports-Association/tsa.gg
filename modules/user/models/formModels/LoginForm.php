...
class LoginForm extends Model
{
    ...
    {
        return [
            'rememberMe' => \app\modules\user\Module::t('login', 'login_remember'),
            'username' => \app\modules\user\Module::t('login', 'login_username'),
            'password' => \app\modules\user\Module::t('login', 'login_password')
        ];
    }
