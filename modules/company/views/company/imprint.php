...
$this->title = \app\modules\company\Module::t('company', 'imprint_header');

/************* Meta Index ****************/
$this->registerLinkTag(['rel' => 'canonical', 'href' => Yii::$app->request->url]);
Yii::$app->MetaClass->writeDefaultMeta($this, $this->title, \app\modules\company\Module::t('company', 'imprint_description'), '@BettyBirnchen');
/************* End Meta Index ****************/
    ...
    <div class="hero">
        ...
        <div class="hero-container row">
            <div class="hero-text col-lg-8">
                <h1 class="hero-title">
                    <?= \app\modules\company\Module::t('company', 'imprint_header') ?>
                </h1>
                <p class="description" >
                    <?= \app\modules\company\Module::t('company', 'imprint_description') ?>
                </p>
            </div>
        </div>
    </div>
