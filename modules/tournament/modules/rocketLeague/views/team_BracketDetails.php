...
<div class="site-team-bracket-details">
                ...
                <div class="col-lg-12 encounterBody">
                    <?php for ($b=1; $b <= $bracketData['base']['bo']; $b++): ?>
                        ...
                        <div class="row text-center blue_bg">
                            <?php foreach ($bracketData['blue']['participantData']['player'] as $player): ?>
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col">
                        ...
                        <?php if(array_key_exists('substitude', $bracketData['blue']['participantData'])) : ?>
                            <div class="row text-center blue_bg">
                                <?php foreach ($bracketData['blue']['participantData']['substitude'] as $player): ?>
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col">
                                                <div class="playerData">
                        ...
                        <div class="row text-center orange_bg">
                            <?php foreach ($bracketData['orange']['participantData']['player'] as $player): ?>
                                <div class="col-12">
                                    <div class="row">
                                        <div class="col">
                                            <div class="playerData">
                        ...
                        <?php if(array_key_exists('substitude', $bracketData['orange']['participantData'])) : ?>
                            <div class="row text-center orange_bg">
                                <?php foreach ($bracketData['orange']['participantData']['substitude'] as $player): ?>
                                    <div class="col-12">
                                        <div class="row">
                                            <div class="col">
                                                <div class="playerData">
